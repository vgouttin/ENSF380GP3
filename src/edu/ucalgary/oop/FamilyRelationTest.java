...
public class FamilyRelationTest {
    ...
    private DisasterVictim personOne = new DisasterVictim("John Dalan", "2025-01-19");
    private DisasterVictim personTwo = new DisasterVictim("Jane Dalan", "2025-02-20");
    ...
    public void testSetAndGetPersonOne() {
        DisasterVictim newPersonOne = new DisasterVictim("New Person", "2025-03-21");
    ...
    public void testSetAndGetPersonTwo() {
        DisasterVictim newPersonTwo = new DisasterVictim("Another Person", "2025-04-22");
